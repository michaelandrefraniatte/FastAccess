...
window.onload = function () {
    ...
    var getitem = storage.get('fastaccess');
    if (getitem != '' & getitem != null & getitem != 'undefined') {
        getitem.then(function(result) {
            var fastaccess = JSON.parse(result.fastaccess || []);
         ...
         .catch(function(error) {
            fastaccess = {};
            pictures = ["black", "img/background1.jpeg", "rgb(20, 20, 20)", "img/background2.jpg", "img/background3.jpg", "rgb(20, 12, 20)"];
            picture = "";
            style = "1";
            boxlinks = ["https://www.google.com", "https://www.youtube.com", "https://app.molotov.tv/channels/", "https://www.tf1.fr", "https://www.6play.fr", "https://www.netflix.com/fr-en/", "https://open.spotify.com"];
            boxnames = ["google", "youtube", "molotov", "tf1", "6play", "netflix", "spotify"];
            changeBox();
            changeStyle();
            changePicture();
            addClick();
...
function addPicture() {
    ...
    storage.set({ 'fastaccess': JSON.stringify(fastaccess) });
    location.reload();
}
...
function exportTableToTXT(filename) {
    ...
    if (getitem != '' & getitem != null & getitem != 'undefined') {
        getitem.then(function(result) {
            ...
            boxnames = fastaccess.boxnames;
            fastaccess = { pictures: pictures, style: style, boxlinks: boxlinks, boxnames: boxnames };
            var txt = JSON.stringify(fastaccess);
